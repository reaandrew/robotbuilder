terraform {
  ...
  backend "s3" {
    bucket  = "jackrea-co-uk-terraform-state"
    key     = "robotbuilder/terraform.tfstate"
    region  = "eu-west-2"
    encrypt = true
  }
}
...
resource "aws_cloudfront_distribution" "website" {
  ...
  comment             = "Robot Builder V11 - 3D Model Viewer"
...
resource "aws_s3_object" "index" {
  ...
  key          = "index.html"
  source       = "../robot-builder-v11.html"
  content_type = "text/html"
  etag         = filemd5("../robot-builder-v11.html")
